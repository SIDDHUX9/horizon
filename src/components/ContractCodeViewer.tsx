...
Generated ZKIR Circuit Defs (10 files):
  ...
  return (
    <div className="space-y-6">
      {/* Banner */}
      <div className="glass-panel p-6 sm:p-8 border-cyan-500/20">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white">Compact Smart Contract & ZKIR</h2>
      ...
      <div className="glass-panel overflow-hidden border-slate-800">
        <div className="flex items-center justify-between border-b border-slate-800 px-4 py-2 bg-slate-950/60">
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span>requestLoan.zkir (Intermediate Rep)</span>
            </button>
            <button
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-slate-400 hover:text-white transition flex items-center gap-1 text-xs"
            title="Copy Code"
          >
        ...
        {/* Code Content */}
        <div className="p-4 overflow-x-auto bg-[#050811] text-xs font-mono leading-relaxed max-h-[600px] overflow-y-auto">
          {activeTab === 'compact' && (
